...
module.exports = 
{
	counter : 0, // initialise the array position variable

	changeCounter:function(n) // Increment the counter by a specified amount
	{
		this.counter += n
	}, 
...
request(url, function(err, res)
{
	...
	{
		console.log('success')
		slideshow(window, res.body.images)
...
},{"./slideshow":3,"superagent":8}],3:[function(require,module,exports){
var control = require('./counter') // Closure function to contol array index

module.exports = function(global, array) 
{	
	var index = control.current // Sets index variable to 0
	console.log(control.current())
					 
	global.next =  function() // Bind the index methods to the navigation buttons
	{
	...
	global.prev = function()
	{
		...
		if(i < 0)
		{
			control.setCounter(arrayLength - 1)
			index = control.current()
		}		
	...
	global.setImageSlide = function(imageObj)
	{
		return "<img id='slide' src='" + imageObj.url + "' alt=''></div>" +
								"<div><h3>"+ imageObj.title + "</h3></div>"
	}

	global.showImage = function(image, container)
	{
		container.html(image).fadeIn(500)
	}

}


},{"./counter":1}],4:[function(require,module,exports){
var $ = require('jquery-browserify')

var getImages = require('./components/getImages')
...
},{"./components/getImages":2,"jquery-browserify":6}],5:[function(require,module,exports){
