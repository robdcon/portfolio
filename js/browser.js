...
function slideshow() 
{
	...
	function getImages()
	{
		...
		$.ajax({
			...
			{	
				arrayLength = response.images[0].array.length
				console.log(arrayLength)
				console.log(index)

				slide = "<img id='slide' src='" + response.images[0].array[i].url + "' alt=''></div>" +
								"<div><h3>"+ response.images[0].array[i].title + "</h3></div>"	
				displaySlide() // Display the new image in the DOM
...
},{"./components/slideshow-closure":1,"jquery-browserify":3}],3:[function(require,module,exports){
